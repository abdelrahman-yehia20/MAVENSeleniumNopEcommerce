...
public class D17_PaymentInformationMoneyOrderTest extends TestBase{

    JavascriptExecutor executor ;
    WebDriverWait wait;

    @Test
    public void paymentInformationMoneyOrder() throws InterruptedException {

        new P02_LoginPage(driver).openLoginPage().AddLoginCredentials("test@example23456.com","12345678");
